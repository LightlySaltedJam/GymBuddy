...
Native mobile application for android created in Android Studio with Java for gym trainers, in order to easily and efficiently keep track of their schedule, clients, gyms and appointments.
